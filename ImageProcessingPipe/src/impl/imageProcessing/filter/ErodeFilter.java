...
/**
 * this class erodes a image by a predefined or external matrix (set kernel data)
 * to increase the impact you can set the repetitions from 1 to ...
 * 
 * @author Chris
 *
 */
public class ErodeFilter extends AbstractFilter<PlanarImageWrapper, PlanarImageWrapper> {
